...
class Thema(models.Model):
    ...
    is_klausur = models.BooleanField(
        verbose_name="Klausurthema?", default=False)
...
class Karten(models.Model):
    ...
    karten_thema = models.ForeignKey(
        Thema, default=1, verbose_name="Thema", on_delete=models.SET_DEFAULT)
